 ...
 *
 * @par Флаги:
 *      Некоторые флаги отключают другие. Чтобы включить флаг обратно,
 *      нужно написать этот флаг после отключения.
 *      По умолчанию включен @b -s.\n
 *      Разрешенные флаги: \n
 *      @b -t[num] Запускает num тестов. Если num отсутствует,
 *          или <= 0, запускается кол-во тестов
 *                 по умолчанию. Отключает решение уравнения. \n
 *      @b -s Включает решение уранения. \n
 *      @b -h, @b --help Выводит помощь. Отключает остальное.
 *
